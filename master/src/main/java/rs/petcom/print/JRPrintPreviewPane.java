...
public class JRPrintPreviewPane extends BorderPane {
  ...
  public JRPrintPreviewPane(JasperReportsContext jasperReportsContext, JasperPrint jasperPrint, ResourceBundle resBundle) {
    ...
    btnActualSize.setStyle("-fx-text-fill: black;");
    btnFitPage.setStyle("-fx-text-fill: black;");
    btnFitWidth.setStyle("-fx-text-fill: black;");
    txtGoTo.setStyle("-fx-text-fill: black;");
    toolBar.setStyle("-fx-background-color: gray;");
    btnFirst.setStyle("-fx-background-color: gray;");
    btnLast.setStyle("-fx-background-color: gray;");
    btnNext.setStyle("-fx-background-color: gray;");
    btnPrevious.setStyle("-fx-background-color: gray;");
    btnPrint.setStyle("-fx-background-color: gray;");
    btnZoomIn.setStyle("-fx-background-color: gray;");
    btnZoomOut.setStyle("-fx-background-color: gray;");
    cmbZoom.setStyle("-fx-font-size: 10px;");
    cmbZoom.setPrefSize(100, 24);
  }
    ...
    Task<Boolean> task = new Task<Boolean>() {
      @Override protected Boolean call() throws Exception {
        try {
          ...
          return JasperPrintManager.getInstance(jasperReportsContext).print(jasperPrint, false);
        } catch (JRException ex) {
          ex.printStackTrace();
        } finally {
