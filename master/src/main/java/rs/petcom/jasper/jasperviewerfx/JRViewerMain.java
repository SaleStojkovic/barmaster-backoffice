...
public class JRViewerMain extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		try {
			String reportFileName = "rs/petcom/master/jasper/TestReport.jasper";
			
			JasperReport report = (JasperReport) JRLoader.loadObject(JRLoader.getResourceInputStream(reportFileName));
			jasperPrint = JasperFillManager.fillReport(report, new HashMap<String, Object>(),  new JREmptyDataSource());
